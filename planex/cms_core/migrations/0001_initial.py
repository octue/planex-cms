    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(1, "circle"), (2, "edge"), (3, "triangle"), (4, "polygon"), (5, "star"), (6, "image")], default=1
                    ),
                ),
                ...
                ("colour", cms_core.fields.ColorField(default="ffffff", help_text="Don't include # symbol.", max_length=6)),
                ...
                (
                    "move_direction",
                    models.PositiveSmallIntegerField(
                        choices=[(1, "none"), (2, "top"), (3, "top-right"), (4, "right"), (5, "bottom-right"), (6, "bottom"), (7, "bottom-left"), (8, "left")],
                        default=1,
                    ),
                ),
                ...
                (
                    ...
                    cms_core.fields.ColorField(blank=True, help_text="Don't include # symbol. Will be overridden by linear gradient", max_length=6),
                ),
                (
                    "css_background_linear_gradient",
                    models.CharField(blank=True, help_text="Enter in the format 'to right, #2b2b2b 0%, #243e3f 28%, #2b2b2b 100%'", max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("image", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="renditions", to="cms_core.AccreditedImage")),
            ],
            options={
