import logging
from django.db.models import BooleanField, CharField, TextField, ForeignKey, CASCADE, SET_NULL, IntegerField
...
class SitePage(Page):
    ...
    subtitle_text = TextField(help_text="A subtitle for the page, which may or may not be shown (depending on page content)", blank=True,)

    allow_below_header = BooleanField(default=False, help_text="Allow the first section to appear beneath the header of the page (useful for hero images)")
    ...
    is_panel_page = BooleanField(default=False, help_text="If true, content will be rendered into a raised central panel instead of straight into the page")

    footer_kind = CharField(choices=FOOTER_CHOICES, default="none", max_length=16, help_text="The panel type defined in the front end application")
