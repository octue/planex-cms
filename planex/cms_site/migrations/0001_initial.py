        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of this section (to refer to in this CMS, not shown on pages)", max_length=80
                    ),
                ),
                (
                    "content",
                            ...
                            (
                                ...
                                wagtail.core.blocks.StructBlock(
                                    [
                                        ...
                                        (
                                            "image",
                                            wagtail.images.blocks.ImageChooserBlock(label="Hero image", required=False),
                                        ),
                                        (
                                            "content",
                                            wagtail.core.blocks.StreamBlock(
                                                [
                                                        ...
                                                        wagtail.core.blocks.StructBlock(
                                                            [
                                                                (
                                                                    "text",
                                                                    wagtail.core.blocks.CharBlock(
                                                                        label="Label", max_length=80, required=False
                                                                    ),
                                                                ),
                                                                (
                                                                    "url",
                                                    ...
                                                    (
                                                        "video",
                                                        wagtail.embeds.blocks.EmbedBlock(label="Video", required=False),
                                                    ),
                                                    (
                                                        "quote",
                                                        wagtail.core.blocks.StructBlock(
                                                ...
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        (
                                                            "name",
                                                            wagtail.core.blocks.CharBlock(
                                                                label="Name", max_length=80, required=True
                                                            ),
                                                        ),
                                                        (
                                                            "image",
                                                            wagtail.images.blocks.ImageChooserBlock(
                                                                label="Photo", required=True
                                                            ),
                                                        ),
                                                        (
                                                            "role",
                                                            wagtail.core.blocks.CharBlock(
                                                                label="Role / Job Title", max_length=80, required=True
                                                            ),
                                                        ),
                                                        (
                                                            "biography",
                                                            wagtail.core.blocks.TextBlock(label="Bio", required=False),
                                                        ),
                                                        (
                                                            "linkedin",
                                                            wagtail.core.blocks.URLBlock(
                                                        ...
                                                        (
                                                            "github",
                                                            wagtail.core.blocks.URLBlock(
                                                                label="GitHub Page", required=False
                                                            ),
                                                        ),
                                                        (
                                                            "medium",
                                                            wagtail.core.blocks.URLBlock(
                                                                label="Medium Page", required=False
                                                            ),
                                                        ),
                                                    ]
                                                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="A subtitle for the page, which may or may not be shown (depending on page content)",
                    ),
                ),
                (
                    "allow_below_header",
                ...
                (
                    ...
                    fontawesome_5.fields.IconField(
                        blank=True, help_text="Choose a font-awesome icon to associate with the page", max_length=60
                    ),
                ),
                (
                    "is_panel_page",
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="sections", to="cms_site.SitePage"
                    ),
                ),
                (
                    "section",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="pages", to="cms_site.Section"
                    ),
                ),
            ],
