    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("dark", models.BooleanField(default=False, help_text="Render the section with the dark theme")),
                ("name", models.CharField(help_text="Name of this section (to refer to in this CMS, not shown on pages)", max_length=80)),
                (
                    "content",
                                            ...
                                            wagtail.core.blocks.StreamBlock(
                                                [
                                                    (
                                                        ...
                                                        wagtail.core.blocks.StructBlock(
                                                            [
                                                                ("text", wagtail.core.blocks.CharBlock(label="Label", max_length=80, required=False)),
                                                                ("url", wagtail.core.blocks.URLBlock(label="URL", required=False)),
                                                            ],
                                                    ...
                                                    ("video", wagtail.embeds.blocks.EmbedBlock(label="Video", required=False)),
                                                    (
                                                        "quote",
                                                        wagtail.core.blocks.StructBlock(
                                                            [
                                                                ("text", wagtail.core.blocks.TextBlock()),
                                                                ("author", wagtail.core.blocks.CharBlock(required=False)),
                                                            ],
                                                ...
                                                block_counts={"button": {"max_num": 1}, "quote": {"max_num": 1}, "video": {"max_num": 1}},
                                                required=False,
                                            ),
                                        ),
                                    ],
                                    ...
                                    [
                                        ...
                                        (
                                            ...
                                            wagtail.core.blocks.ListBlock(
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        ("name", wagtail.core.blocks.CharBlock(label="Name", max_length=80, required=True)),
                                                        ("image", wagtail.images.blocks.ImageChooserBlock(label="Photo", required=True)),
                                                        ("role", wagtail.core.blocks.CharBlock(label="Role / Job Title", max_length=80, required=True)),
                                                        ("biography", wagtail.core.blocks.TextBlock(label="Bio", required=False)),
                                                        ("linkedin", wagtail.core.blocks.URLBlock(label="LinkedIn Page", required=False)),
                                                        ("twitter", wagtail.core.blocks.URLBlock(label="Twitter Page", required=False)),
                                                        ("github", wagtail.core.blocks.URLBlock(label="GitHub Page", required=False)),
                                                        ("medium", wagtail.core.blocks.URLBlock(label="Medium Page", required=False)),
                                                    ]
                                                ),
                                                label="Team Members",
                                            ),
                                            ...
                                            wagtail.core.blocks.ListBlock(
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        ...
                                                        ("link_url", wagtail.core.blocks.URLBlock(label="Link URL", required=False)),
                                                    ]
                                                ),
                                                label="Images",
                                            ),
                                                ...
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        ...
                                                        (
                                                            "quote",
                                                            wagtail.core.blocks.TextBlock(
                                                                help_text="The nice things they have to say", label="Quote", max_length=100, required=True
                                                            ),
                                                        ),
                                                        (
                                                            "image",
                                                ...
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        ...
                                                        (
                                                            "more_info_url",
                                                            wagtail.core.blocks.URLBlock(
                                                                help_text="A link to be followed for more information", label="URL", required=False
                                                            ),
                                                        ),
                                                    ]
                                                ),
                                                ...
                                                wagtail.core.blocks.StructBlock(
                                                    [
                                                        ...
                                                        (
                                                            "image",
                                                            wagtail.images.blocks.ImageChooserBlock(
                                                                help_text="Pick an image to represent this product", label="Image", required=False
                                                            ),
                                                        ),
                                                        (
                                                            "more_info_url",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("subtitle_text", models.TextField(blank=True, help_text="A subtitle for the page, which may or may not be shown (depending on page content)")),
                (
                    "allow_below_header",
                    models.BooleanField(default=False, help_text="Allow the first section to appear beneath the header of the page (useful for hero images)"),
                ),
                ("icon", fontawesome_5.fields.IconField(blank=True, help_text="Choose a font-awesome icon to associate with the page", max_length=60)),
                (
                    "is_panel_page",
                    models.BooleanField(
                        default=False, help_text="If true, content will be rendered into a raised central panel instead of straight into the page"
                    ),
                ),
                (
                    "footer_kind",
                    models.CharField(
                        choices=[("none", "No footer"), ("micro", "Micro footer"), ("small", "Small Footer"), ("big", "Big footer")],
                        default="none",
                ...
                (
                    "background_image",
                    models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="+", to="cms_core.AccreditedImage"),
                ),
            ],
        ...
        migrations.CreateModel(
            name="PageSectionsOrderable",
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("sort_order", models.IntegerField(blank=True, editable=False, null=True)),
                ("page", modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name="sections", to="cms_site.SitePage")),
                ("section", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="pages", to="cms_site.Section")),
            ],
