from wagtail.core.blocks import StructBlock, ListBlock, CharBlock, TextBlock, ChoiceBlock
...
class TestimonialBlock(StructBlock):
    ...
    stars = ChoiceBlock(
        required=True, choices=[(None, "No rating"), (0, "0 Stars"), (1, "1 Star"), (2, "2 Stars"), (3, "3 Stars"), (4, "4 Stars"), (5, "5 Stars")], icon="pick"
    )
...
class TestimonialSectionBlock(SectionBlock):
    heading = CharBlock(
        required=False, max_length=100, label="Section Heading", help_text="Add a heading at the beginning of this page section", default="Testimonials"
    )
