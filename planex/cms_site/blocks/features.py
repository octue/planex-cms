from wagtail.core.blocks import StructBlock, ListBlock, CharBlock, TextBlock, URLBlock
...
class FeatureBlock(StructBlock):
    feature_name = CharBlock(required=True, max_length=80, label="Feature Name", help_text="Feature name. Keep it short, like 'Free Chat' or 'Secure'")
    feature_description = TextBlock(required=True, max_length=400, label="Feature Description", help_text="Write a few lines about this feature")
