...
class CardBlock(StructBlock):
    title = CharBlock(required=True, max_length=80, label="Name", help_text="Name of a product. Keep it short, like 'Mega Kit Pro' or 'Cloud Manager'")
    body = TextBlock(required=True, max_length=400, label="Description", help_text="Write a few lines about this product")
